...
<head>
    ...
    <script type="text/javascript" src="/leyoou/leyoou/Public/Common/js/jquery-1.7.1.min.js"></script>
                ...
                <ul class="nav navbar-nav user-menu navbar-right">
                    <!--<li>
                        <span href="" class="settings">
                            ...
                            <span class="txt"> ：<span id="order_count">您有【<?php echo ($order_count); ?>】个新的订单请注意查收</span></span>
                        </span>
                    </li>-->
                    <li>
                        <span href="" class="settings">
                            <span class="icon glyphicon glyphicon-home"></span>
                            <span class="txt">：<a href="http://www.pitchina.com.cn" target="_blank">网站首页</a></span>
                        </span>
                    </li>
                    <li>
                        <span href="" class="settings">
...
<?php if(!empty($order_count)): ?><!--<object data="/leyoou/leyoou/Public/Home/audio/prompt.mp3" type="application/x-mplayer2" width="0" height="0">
        <param name="src" value="/leyoou/leyoou/Public/Admin/audio/prompt.mp3">
...
//            $.ajax({
//                url: '<?php echo U("Order/ajaxGetOrder");?>',type: 'post',data: {},dataType: 'JSON',
