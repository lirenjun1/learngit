...
<head>
    ...
    <script type="text/javascript" src="/learngit/Public/Common/js/jquery-1.7.1.min.js"></script>
...
<?php if(!empty($order_count)): ?><!--<object data="/learngit/Public/Home/audio/prompt.mp3" type="application/x-mplayer2" width="0" height="0">
        <param name="src" value="/learngit/Public/Admin/audio/prompt.mp3">
