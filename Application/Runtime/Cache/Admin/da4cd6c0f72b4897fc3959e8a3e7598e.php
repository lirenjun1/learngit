...
<head>
	...
	<title></title>
	<link rel="stylesheet" href="/happy/Application/Public/Admin/css/reset.css">
	<link rel="stylesheet" href="/happy/Application/Public/Admin/css/public.css">
</head>
<body>
<div class="public-header-warrp">
	<div class="public-header">
		<div class="content">
			<div class="public-header-logo"><a href=""><i>LOGO</i><h3>乐活网</h3></a></div>
...
<div class="public-ifame mt20">
	...
	<!-- 内容模块头 -->
		...
		<iframe name="content" src="<?php echo U('Admin/Index/main');?>" frameborder="0" id="mainframe" scrolling="yes" marginheight="0" marginwidth="0" width="100%" style="height: 700px;"></iframe>
		</div>
	</div>
</div>
<script src="/happy/Application/Public/Admin/js/jquery.min.js"></script>
<script>
$().ready(function(){
