...
class ProductionModel extends Model {
    protected $tableName = 'production';
    /**
     * @var array
     * 自动完成   新增时
     */
     ...
     * 查询多条数据
     */
        public function selectProduction($where = array(),$order = '',$page_size = '',$parameter = array()){
     ...
     * 查询一条数据
     */
    public function findProduction($where){
        if(empty($where)){
            return false;
        }else{
            if($where['status'] == '' || empty($where['status'])){
     ...
     * 删除数据
     */
    public function deleteProduction($where){
        if(empty($where)){
            return false;
        }
