...
class OautWxModel extends Model{
    protected $tableName = 'oaut_wx';

    public function checkLogin($data){
        $where['wx_id'] = $data['wx_id'];
    ...
    public function addWx($m_id){
        $data = $_SESSION['OAUT_WX'];
        $data['m_id'] = $m_id;
        $this->data($data)->add();
        unset($_SESSION['OAUT_WX']);
    }
}